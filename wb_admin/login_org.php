    ...
    <td align="center" valign="top">
			...
			<input type="hidden" name="ret_url" value="<?=$_url['admin']?>index.php">
				<table align="center" cellpadding="0" cellspacing="0" width="500">
					<tr> 
						<td width="100"> <p><img src="images/logo.gif" width="124" height="60" border="0"></p></td>
						<td align="center"> <p> 관리자 접속을 위한 인증 단계 입니다.<br>
				...
				<table align="center" border="1" cellpadding="0" cellspacing="0" width="400" bordercolordark="white" bordercolorlight="#E1E1E1">
					<tr> 
						<td width="130" height=30 align="right" bgcolor="#F7F7F7">관리자 아이디&nbsp;:&nbsp;</span></td>
						<td width="264"><input type="text" name="mb_id" size="20" maxlength="20" minlength="2" required hname="아이디" class="input"></td>
					</tr>
					<tr> 
						<td height=30 align="right" bgcolor="#F7F7F7">관리자 암호&nbsp;:&nbsp;</span></td>

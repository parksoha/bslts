...
?>
<script src="../wb_js/jquery-1.8.1.min.js"></script>
...
<tr>
    <td>시작 일시</td>
    <td>
        <input type=text class=ed name="nw_begin_time" id="nw_begin_time" size=21 maxlength=19 value='<? echo $nw[nw_begin_time] ?>' required hname="시작 일시">
        
	</td>
    <td>종료 일시</td>
    <td>
        <input type=text class=ed name="nw_end_time" id="nw_end_time" size=21 maxlength=19 value='<? echo $nw[nw_end_time] ?>' required hname="종료 일시">

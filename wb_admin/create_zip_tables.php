...
<?
		...
		foreach($data_a as $data) {
			...
			if($data) {
				...
				// UTF-8 추가
				$tmp[0] = iconv('euc-kr', 'utf-8', $tmp[0]);
				$tmp[1] = iconv('euc-kr', 'utf-8', $tmp[1]);
				$tmp[2] = iconv('euc-kr', 'utf-8', $tmp[2]);
				$tmp[3] = iconv('euc-kr', 'utf-8', $tmp[3]);
				$tmp[4] = iconv('euc-kr', 'utf-8', $tmp[4]);
				$tmp[5] = iconv('euc-kr', 'utf-8', $tmp[5]);

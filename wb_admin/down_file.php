<?
$filename_org =  iconv('utf-8', 'euc-kr', $filename_org);
...
$file_url="../wb_data/".$file_dir."/".$filename; // 실제로 다운받을 파일이 있는 경로 
...
$file_exist=file_exists($file_url);
 ...
 if($file_exist==1)
 {
  ...
  //echo"$files";exit;
  file_transact($file_url, "file",$filename_org,$files);
 }
 else
 {
  echo"
...
<!-- 링크페이지 <a href="down.php?filename=xxxx.jpg&filename_org=abcde.jpg">파일다운로드</a> -->

...
//		if($validate->is_empty($mb_nick)) $mb_nick=$_mb['mb_id'];
		...
		// 파일 업로드
		$mb_files=upload_file($_path['member_data'],"mb_files",$data['mb_num'],$data['mb_files'],$mb_files_del);
...
<div id="member2" style="margin-top:20px; float:left; width:100%;">
	<div class="join">
		<form action="?" method="post" enctype='multipart/form-data' name="member_form" id="member_form" onsubmit="return validate(this)">
			...
			<div class="btn" style="width:100%; height:auto; float:left; text-align:center;"><input type="submit" value="수정완료" class="next ok_btn_sty3"></div>
		</form>
	</div>
</div>

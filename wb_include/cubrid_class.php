...
/* =====================================================
	프로그램명 : 알지보드 V4
	화일명 : cubrid_class.php (큐브리드 클래스)
  작성일 : 2007. 7. 02
  작성자 : 윤범석 ( http://rgboard.com )
  작성자 E-Mail : master@rgboard.com
	
	최종수정일 : 2007-07-13
2007-07-13 escape 문자 제거, 싱글쿼터 처리 추가 ' -> ''
2007-07-16 디비클래스에 escape_string 함수추가
 ===================================================== */
 
if (!defined('CUBRID_INC_INCLUDED')) 
{
	define('CUBRID_INC_INCLUDED', 1);
// *-- CUBRID_INC_INCLUDED START --*
	class recordset
	{

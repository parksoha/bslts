...
<link rel="stylesheet" type="text/css" href="<?=$site_path?>css/style3.css" />
<!-- 스크립트 오류 표시 안보이게 -->
...
<script src="<?=$site_path?>include/common3.js"></script>
	...
	<div class="wrap_pc2">
		<div class="wrap_pc">
			...
			<div class="top">
				<div class="mo_logo">
					<ul>
						<li class="mo_top_home"><a href="javascript:typetree();"><img src="<?=$site_path?>images/mo_menus.jpg"></a></li>    
				...
				<div class="top_hsc">
					<ul>					
						...
						<li style="width:25%;"><a href="javascript:menu3sub2();">Contact Us</a></li>
				...
				<?include($site_path.'include/left_menu3.php');?>
				...
				<?
					...
					$widt = floor (740 / count($menu_info)); // 메뉴 넓이 나누기 메뉴개수
...
<?include($site_path."include/vi_sub.php");?>
	...
	<div class="con">
		...
		<div class="sub_menu">
			...
			<ul class="sub_menu3">
				<li><img src="<?=$site_path?>images/call_bansd4.gif"></li>
			</ul>

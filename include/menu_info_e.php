...
if($file_name=="index.php" || $file_name=="_index.php" || $file_name=="index1.php" || $file_name=="index2_e.php" || $file_name=="index3.php" || $file_name=="index4.php") $bodyClass="Main"; else $bodyClass="Sub";

$sub1=array('Company','Organization chart','Directions');
$sub2=array('Semiconductor Equipment','Display Equipment','Utility');
$sub3=array('ISO 9001','SSQ','STQA');
$sub4=array('Manufacture & Production facilites');
$sub5=array('Major partners');
$sub6=array('Notice','Q&A','Recruit');
...
$menu_names=array('COMPANY','PRODUCTS/Service','QUALITY CERTIFICATION/Introduction','PRODUCTION FACILITIES/Customer','MAJOR PARTNERS/Membership','CUSTOMER SERVICE/Membership');
$menu_info=array($sub1,$sub2,$sub3,$sub4,$sub5,$sub6);

//보드일경우
$board_array=array("sub6_2_e"=>"6:2","sub6_1_e"=>"6:1","sub6_3_e"=>"6:3");

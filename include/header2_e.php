...
<script type="text/javascript" src="<?=$site_path?>include/menu_e.js"></script>
			   ...
			   <div class="logo"><a href="javascript:home();"><img src="<?=$site_path?>wb_data/design/<?=$logo1[logo1]?>" alt="<?=$_site_info['site_name']?>" ></a></div>        
				...
				<div class="top_hsc">
					<ul>					
						...
						<li style="width:25%;"><a href="javascript:index_e();"><b style="font-weight:bold; font-size:12px; color:#0f53ed;">English</b></a></li>
						<li style="width:25%;"><a href="javascript:index_j();">Japanese</a></li>
				...
				<div style="width:auto; height:auto; float:left;" class="opsnd">
					...
					<?
						...
						for($i=0;$i<count($menu_info);$i++){
							...
							echo '<a href="javascript:menu'.($i+1).'();" class="'.$selected.' topmenus" style="font-size:12px;">'.$menu_names2[0].'</a>';						
							echo '</li>';
						}
						echo '</ul>';
					?>

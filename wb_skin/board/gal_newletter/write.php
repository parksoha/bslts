...
<div id="g_write_style" style="float:left; width:100%; margin-top:20px;">
	...
	<div class="input_list">
		<ul class="list">
			...
			<li>
				...
				<input name="bd_subject" type="text" class="input" value="<?=$bd_subject?>" size="70" maxlength="60" hname="제목" required>
			</li>
			<li>
				<span class="title need">리스트</br>설명 및 요약내용</span>
				<textarea name="bd_ext1" rows="5" cols="68" hname="요약내용" required><?=$bd_ext1?></textarea>
			</li>
			<? if($wcfg['use_home']) { ?>
			<li>
				<span class="title">홈페이지</span>
				<input name="bd_home" type="text" class="input" value="<?=$bd_home?>" size="70"> 
				<span class="info">ex) http://yahoo.com</span>
			</li>
			<? } ?>
			<? if($wcfg['use_html']) {
			$textHeight = "300";

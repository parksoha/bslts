<?
		if(!$msg)
			switch($_msg_type) {
				...
				case "view_no_auth_member" : $msg='글을 읽을 권한이 없습니다.';
				break;
				case "view_no_auth_guest" : $msg='글을 읽을 권한이 없습니다.<br>회원인경우 로그인 해주세요.';
				break;
				
				case "view_secret_error" : $msg='비밀글을 볼수 없습니다.';
				break;
				case "view_secret_error_auth_guest" : $msg='비밀글을 볼수 없습니다.<br>회원인경우 로그인 해주세요.';
				break;
				case "view_secret_pass_error" : $msg='다시 입력바랍니다.';
				break;
...
<div style="width:280px; margin:0 auto;">
	...
	<br />
	<br />
	<img src="<?=$skin_url?>images/confirm.gif" onclick="history.back();" align="absmiddle" style="cursor:pointer; margin-left:-5px;">
	</td></tr>
	</table>
	</td></tr>
	</table>

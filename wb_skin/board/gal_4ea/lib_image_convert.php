<?
FUNCTION thumbnailImageCreate($image_path, $save_path, $max_with_size=120, $max_height_size=100, $waterMakeImagePath="", $save_format="jpg", $background_color="WHITE", $image_quality=300){

...
<? } ?>
	...
	<div class="search_box search_box_pc">
		...
		<?=$_post_param[0]?>
			...
			<input name="kw" type="text" id="kw" value="<?=$kw?>" hname="검색어" style="border:0px;width:150px;height:24px;color:#666666; border:1px solid #CCCCCC; background:#ffffff;" required>

...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td width="80%" align="left">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="site_list">
			  <tr> 
				<th width="16%"> 일시 </th>
				<th width="10%"> 아이피</th>
		...
		<td width="20%" align="right" valign="top">
			...
			<table width="90%" border="0" cellspacing="0" cellpadding="0" class="site_list">
				...
				<?
				$sql_cony = "select country,COUNT(*) as sums from wb_tb_counter_log where country !='' group by country";

...
/* =====================================================
 ...
 ===================================================== */
	...
	if($_SERVER['REQUEST_METHOD']=='POST' && $clnss=='ok') {
		mysql_query("delete from wb_tb_counter_day");
		mysql_query("delete from wb_tb_counter_etc");
		mysql_query("delete from wb_tb_counter_host");
		mysql_query("delete from wb_tb_counter_log");
		mysql_query("delete from wb_tb_counter_search");
		rg_href("/wb_counter/","초기화를 완료하였습니다.");
	}
?>
...
<input type="button" value="pc접속통계 초기화" class="button" style="cursor:pointer;" onclick="clns();">
</form>

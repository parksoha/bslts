...
/* 달력 환경설정 */
	function Calendar_Config(type){
		...
		var yoil = new Array("<img src='" + calendar_path + "/images/cal_0.jpg'>","<img src='" + calendar_path + "/images/cal_1.jpg'>","<img src='" + calendar_path + "/images/cal_2.jpg'>","<img src='" + calendar_path + "/images/cal_3.jpg'>","<img src='" + calendar_path + "/images/cal_4.jpg'>","<img src='" + calendar_path + "/images/cal_5.jpg'>","<img src='" + calendar_path + "/images/cal_6.jpg'>");
		...
		var today = new Array("<b style='color:#006600'>", "</b>", "background: url('" + calendar_path + "/images/mini3.gif') no-repeat; background-position:2 0;");
		//마우스 오버 색깔
		var over = '#E1E1E1';
		//달력 이동 버튼들
		var move = new Array("<img src='" + calendar_path + "/images/month_prev.gif' border=0><img src='" + calendar_path + "/images/month_prev.gif' border=0>", "<img src='" + calendar_path + "/images/month_prev.gif' border=0>", "<img src='" + calendar_path + "/images/month_next.gif' border=0>", "<img src='" + calendar_path + "/images/month_next.gif' border=0><img src='" + calendar_path + "/images/month_next.gif' border=0>");
		//분리문자 2009-01-01
		var sp = "-";
		return eval(type);
	}
	...
	function Calendar_Display(sd, ld){
		...
		for(var i=0; i<ld+sd; i++){
			...
			if(i < sd) {
				...
				In_HTML += "<td align=center style=\"cursor:pointer;\" onclick='Calendar_SetValue(" + disp_date + ");formCheck();' onmouseover=\"Calendar_ChangeBG(this, 'set');\" onmouseout=\"Calendar_ChangeBG(this, 'unset');\"><font color='" + yoil_color[disp_yoil] + "'>" + disp_date + "</font></td>";
				disp_date++;
			}
			disp_yoil++;
		}

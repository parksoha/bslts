...
if (typeof(CALENDAR_JS) == 'undefined') // 한번만 실행
{
	...
	var Fld_Obj;
	var g4_path = "/J_calendar";
/* 달력 환경설정 */
	function Calendar_Config(type){
		//날짜 셀의 크기지정 가로, 세로
		var cell = new Array(25, 21);
		//요일타이틀 색깔지정 혹은 이미지 대체 (일, 월, 화, 수, 목, 금, 토) 순으로
		var yoil = new Array("<img src='" + g4_path + "/images/cal_0.jpg'>","<img src='" + g4_path + "/images/cal_1.jpg'>","<img src='" + g4_path + "/images/cal_2.jpg'>","<img src='" + g4_path + "/images/cal_3.jpg'>","<img src='" + g4_path + "/images/cal_4.jpg'>","<img src='" + g4_path + "/images/cal_5.jpg'>","<img src='" + g4_path + "/images/cal_6.jpg'>");
		...
		var today = new Array("<b style='color:#006600'>", "</b>", "background: url('" + g4_path + "/images/mini3.gif') no-repeat; background-position:2 0;");
		//마우스 오버 색깔
		var over = '#E1E1E1';
		//달력 이동 버튼들
		var move = new Array("<img src='" + g4_path + "/images/month_prev.gif' border=0><img src='" + g4_path + "/images/month_prev.gif' border=0>", "<img src='" + g4_path + "/images/month_prev.gif' border=0>", "<img src='" + g4_path + "/images/month_next.gif' border=0>", "<img src='" + g4_path + "/images/month_next.gif' border=0><img src='" + g4_path + "/images/month_next.gif' border=0>");
		//분리문자 2009-01-01
		var sp = "-";
		return eval(type);
	}
	...
	function Calendar_Display(sd, ld){
		...
		if(!document.getElementById('Calendar_Div')){
			if(document.layers){ 
				...
				Makej_Div.setAttribute("id", "Calendar_Div");

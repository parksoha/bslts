...
/* 달력 환경설정 */
	function Calendar_Config(type){
		...
		var today = new Array("<b style='color:#006600'>", "</b>", "background: url('" + g4_path + "/img/mini3.gif') no-repeat; background-position:2 0;");
		//마우스 오버 색깔
		var over = '#E1E1E1';
		//달력 이동 버튼들
		var move = new Array("<img src='" + g4_path + "/img/month_prev.gif' border=0><img src='" + g4_path + "/img/month_prev.gif' border=0>", "<img src='" + g4_path + "/img/month_prev.gif' border=0>", "<img src='" + g4_path + "/img/month_next.gif' border=0>", "<img src='" + g4_path + "/img/month_next.gif' border=0><img src='" + g4_path + "/img/month_next.gif' border=0>");
		//분리문자 2009-01-01
		var sp = "-";
		return eval(type);
	}
